...
<body>
		...
		<div class="right">
			...
			<div class="top">
				<div class="brandNameBox">
					<h3 id="brandName">passion for Fashion</h3>
					<span class="movebtn">&rang;&rang;</span> <br> <br>
					<!-- 브랜드명 옆 > 모양 -->
				</div>
				<div style="font-size: 20px; font-weight: 200;">상품명 :</div>
				<h2 class="productName" style="font-weight: 200; margin-bottom: 15px; font-size: 30px;"> oxpord shirts(blue)</h2>
				<hr style="color: #dfdfdf;">
				<div class="productNO">
					<span class="productNo" style="margin-top: 10px; font-size: 20px; font-weight: 200;">NO.11475413</span>
				</div>

				<h2 id="discount" style="font-size: 25px; font-weight: 200;">
					10 <span>%</span>
					<!-- 할인율 -->
				</h2>
				<div id="originPrice"
					style="font-size: 25px; display: inline-block; font-weight: 200; margin-right: 220px;">10,000</div>
				<span id="discountPrice" style="font-size: 35px; float: rightl; font-weight: 200;">9,000</span>
				<!-- 상품가격 -->
			</div>
			<div>
				배송정보
				...
				<form action="" method="get">
					...
					<div id="productResult">
						...
						<button class="removeProudct" type="button" style="float: right;">
							<img src="img/close.png" style="width: 10px;">
						</button>
	...
	<div class="reviewbox">
		...
		<h3>
			<a href="javascript:window.scrollTo( 0, 2800 );"> 
				상세 정보
			</a>
		
		</h3>
		<h3>
			<a href="javascript:window.scrollTo( 0, 3500 );"> 
				리뷰
			</a>
		</h3>
		<h3>
			<a href="javascript:window.scrollTo( 0, 4250 );">
				연관 상품
			</a>
		</h3>
		<h3>
			<a href="javascript:window.scrollTo( 0, 5500 );">
			반품 및 교환
			</a>
		</h3>
	</div>
	...
	<div class="Infobox">
		<!-- 제품 사진 및 소개 칸 -->
		<div class="imgbox">
			<img src="img/shirts2.jpg"> <img src="img/shirts3.jpg"> <img
				src="img/shirts4.jpg">
		</div>
		<br>
...
<!-- 	<hr style="color: #dfdfdf; width: 90%; margin: auto;"> -->
	<div class="reviewWrap"
		...
		( <span>1</span> )
		<span style="margin-left: 20px; font-weight: 200;"> more &rang;&rang;</span>
<!-- 		<div style="font-weight: 200;"> -->
<!-- 			구매만족도<span class="reviewGrade" style="font-weight: 200;">5.0</span> -->
<!-- 		</div> -->
<!-- 		<div style="font-size: 20px; font-weight: 200;">★★★★☆</div> -->
		<div class="textbox">
			<div>
				<div class="nickName"
					style="font-size: 18px; margin-top: 10px; margin-bottom: 10px; display: inline-block; font-weight: 200;">user***</div>
			...
			<div style="display: inline-block; width: 100%; margin-bottom: 30px;">
				<span class="reviewComment" style="font-weight: 400;">사이즈 보통이에요</span> 
				<span class="reviewComment" style="font-weight: 400;">색상 밝아요</span> 
				<span class="reviewComment" style="font-weight: 400;">두께 얇아요</span>
	...
	<br>
		...
		<div class="commProduct" style="width:100%; height:500px;margin-top: 100px; text-align: center;">
				...
				<ul>
					...
					<li>
						<a href="http://www.naver.com">
							<img alt="" src="img/cloths4.jpg">
							<p>Heavy Hooded Sweat Shirt(zipup)_black</p>
							<p>100,000</p>
						</a>
					</li>
	...
	size[0].addEventListener("change", function(){	// select사이즈 의 value값이 바뀌면 실행
		...
		for(const sizeSelect of size){
			if(sizeSelect.value != ''){	
					...
					productPrice.innerText=9000+3000;
	...
	increase.addEventListener("click", function(){
		buyCount.value++;
		productPrice.innerText = buyCount.value*9000+3000;
